...
//      self.currentTabIndex = 3
    ...
    override func viewDidLoad() {
        ...
        data = [bcs as Dictionary<String, AnyObject>, bb as Dictionary<String, AnyObject>, fs as Dictionary<String, AnyObject>, f as Dictionary<String, AnyObject>, got as Dictionary<String, AnyObject>, g as Dictionary<String, AnyObject>, hoc as Dictionary<String, AnyObject>, himym, s, tbbt, twd]
    ...
    func widthForTabAtIndex(_ index: Int) -> CGFloat {
        if DeviceType.iPad {
            ...
            var tabSize = (data[index]["title"] as! String).size(attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: 17)])
